...
打开Lights-IM客户端根目录，找到host文件并打开，把默认服务器地址修改为你的服务器外网地址

例如，假设服务端源码目录为 **./part/lightsim**

**假设**服务器外网ip为 **192.168.0.1**

那么就应该把 **192.168.0.1/part/lightsim** 填写到host里

**假设**你有域名 **data.lightsim.cn** 指向了 **192.168.0.1**

那么就应该把 **data.lightsim.cn/part/lightsim** 填写到host里 ****

**假设**你的服务器外网端口**不是**默认端口80，而是其他的端口，**例如**45126

那么就应该把 **192.168.0.1:45126/part/lightsim** 填写到host里

或把 **data.lightsim.cn:45126/part/lightsim** 填写到host里
...
在Lights-IM源码里找到md5.cpp替换为以上代码并重新编译

关于APIKey和SercetKey不再过多赘述
